...
(6,2, 'GREEN BUNGALOW', 'cabanaverde.png', '["Disabled Access","1 room with bathroom ","Full or twin bed","Terrace with beautiful views of the jungle","Maximum 3 Guest","Wide Construction","Modern Architecture","Private Bathroom","Hot Water","Terrace with view to the Forest and Mountains"]', 'en'),
(7,3, 'WIDE GREEN BUNGALOW', 'cabanaverdeamplia.png', '["Disabled Access","1 room with bathroom ","Full or twin bed","Terrace with beautiful views of the jungle","Maximum 4 Guest","Wide Construction","Modern Architecture","Private Bathroom","Hot Water","Terrace with view to the Forest and Mountains"]', 'en'),
(8,4, '2 BEDROOM BUNGALOW', 'cabanadoshabitaciones.png', '["Disabled Access","1 room with bathroom ","Full or twin bed","Terrace with beautiful views of the jungle","Maximum 4 Guest","Wide Construction","Modern Architecture","Private Bathroom","Hot Water","Terrace with view to the Forest and Mountains"]', 'en');
